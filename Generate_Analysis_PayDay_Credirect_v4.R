...
df_final <- read.csv("Results_Logit_for_Analysis_PayDay.csv", sep=",")
...
# Output
write.xlsx(df_analysis,paste(
  "C:\\Projects\\Application_Scoring\\Credirect_v4\\",
  "results\\Profit_Analysis_PayDay.xlsx",sep=""))
