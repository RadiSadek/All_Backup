...
df_final <- read.csv("Results_Logit_for_Analysis_without_email.csv", sep=",")
...
# Define cut-off
df_final$default_flag_Predict <- ifelse(df_final$Score>0.25,1,0)


# USER CHOOSES CUTS 
# Cut into optimum groups
bins(df_final$Score, target.bins = 10, minpts = 10)
bins <- c(0,0.025,0.0375,0.05,0.0625,0.075,0.875,
