...
df$return_rate180 <- ifelse(df$return_rate180>0.6,1,0)
...
decision_tree_model <- ctree(return_rate180 ~ education + ratio_passed_installments + ratio_last_amount_paid + 
                             ...
                             days_diff_last_credit + experience_employer + period + paid_time180 + 
                             credits_cum, 
                             data = df80, 
...
save(decision_tree_model_180, file = "Decision_Trees_180_60pct.rdata")
