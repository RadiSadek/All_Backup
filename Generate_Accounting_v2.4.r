...
acc_report <- read.xlsx("Accounting_Report_Input_without_finstart.xlsx")
...
###########>>>>>>>>>>>> OUTPUT
write.xlsx(acc_report, "Accounting_Report_Output_1.xlsx", 
           sheetName="Sheet 1", 
           col.names=TRUE, row.names=FALSE, append=FALSE, showNA=TRUE)
write.xlsx(table_Обезценка, "Accounting_Report_Output_2.xlsx", 
           sheetName="Sheet 1", 
           col.names=TRUE, row.names=FALSE, append=FALSE, showNA=TRUE)
